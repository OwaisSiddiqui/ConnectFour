...
from Disc import DISC_PIXEL_DIAMETER
...
FIRST_COLUMN_RIGHT_BORDER = LEFT_BOARD_SPACE + X_SPACE_BETWEEN_LEFT_DISC + DISC_PIXEL_DIAMETER + \
                            X_SPACE_BETWEEN_DISCS / 2
SECOND_COLUMN_LEFT_BORDER = FIRST_COLUMN_RIGHT_BORDER
SECOND_COLUMN_RIGHT_BORDER = SECOND_COLUMN_LEFT_BORDER + DISC_PIXEL_DIAMETER + X_SPACE_BETWEEN_DISCS / 2
THIRD_COLUMN_LEFT_BORDER = SECOND_COLUMN_RIGHT_BORDER
THIRD_COLUMN_RIGHT_BORDER = THIRD_COLUMN_LEFT_BORDER + DISC_PIXEL_DIAMETER + X_SPACE_BETWEEN_DISCS / 2
FOURTH_COLUMN_LEFT_BORDER = THIRD_COLUMN_RIGHT_BORDER
FOURTH_COLUMN_RIGHT_BORDER = FOURTH_COLUMN_LEFT_BORDER + DISC_PIXEL_DIAMETER + X_SPACE_BETWEEN_DISCS / 2
FIFTH_COLUMN_LEFT_BORDER = FOURTH_COLUMN_RIGHT_BORDER
FIFTH_COLUMN_RIGHT_BORDER = FIFTH_COLUMN_LEFT_BORDER + DISC_PIXEL_DIAMETER + X_SPACE_BETWEEN_DISCS / 2
SIXTH_COLUMN_LEFT_BORDER = FIFTH_COLUMN_RIGHT_BORDER
SIXTH_COLUMN_RIGHT_BORDER = SIXTH_COLUMN_LEFT_BORDER + DISC_PIXEL_DIAMETER + X_SPACE_BETWEEN_DISCS / 2
SEVENTH_COLUMN_LEFT_BORDER = SIXTH_COLUMN_RIGHT_BORDER
SEVENTH_COLUMN_RIGHT_BORDER = SEVENTH_COLUMN_LEFT_BORDER + DISC_PIXEL_DIAMETER + X_SPACE_BETWEEN_DISCS / 2
